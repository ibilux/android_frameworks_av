...
#ifdef MTK_HARDWARE
                    msg->setInt32("ticks",omx_msg.u.extended_buffer_data.token_tick);
                        if(0x00010000 == (0x00010000 & omx_msg.u.extended_buffer_data.flags))
                        {
                            msg->setInt32("token_VA",omx_msg.u.extended_buffer_data.token_VA);
                            msg->setInt32("token_PA",omx_msg.u.extended_buffer_data.token_PA);
                            msg->setInt32("token_FD",omx_msg.u.extended_buffer_data.token_FD);
                        }
                        else
                        {
                            msg->setInt32("token_VA",0);
                            msg->setInt32("token_PA",0);
                            msg->setInt32("token_FD",0);
                        }
#endif
                    break;
                }
